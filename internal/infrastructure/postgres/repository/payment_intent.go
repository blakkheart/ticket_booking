...
func (repo *paymentIntentRepository) Create(
	ctx context.Context,
	p *models.PaymentIntent,
) error {
	return nil
}

func (repo *paymentIntentRepository) Get(
	ctx context.Context,
	id uuid.UUID,
...
func (repo *paymentIntentRepository) GetByBookingID(
	ctx context.Context,
	bookingID uuid.UUID,
) (*models.PaymentIntent, error) {
	return nil, nil
...
func (repo *paymentIntentRepository) GetMany(
	ctx context.Context,
	filter any,
) ([]*models.PaymentIntent, error) {
	return nil, nil
...
func (repo *paymentIntentRepository) Update(
	ctx context.Context,
	booking *models.PaymentIntent,
) error {
	return nil
}

func (repo *paymentIntentRepository) fromSqlcPaymentIntent(
